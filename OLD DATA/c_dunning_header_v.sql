-- View: adempiere.c_dunning_header_v

-- DROP VIEW adempiere.c_dunning_header_v;

CREATE OR REPLACE VIEW adempiere.c_dunning_header_v
 AS
...
ALTER TABLE adempiere.c_dunning_header_v
    OWNER TO postgres;
